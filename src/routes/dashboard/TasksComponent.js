...
const TAGS = {
    URGENT: { text: 'Completed', backgroundColor: '#FEC400', color: '#FFFFFF' },
    NEW: { text: 'In Progress', backgroundColor: '#29CC97', color: '#FFFFFF' },
    DEFAULT: { text: 'To Start', backgroundColor: '#F0F1F7', color: '#9FA2B4' }
};
...
function TasksComponent(props) {
    ...
    const [items, setItems] = useState([
        { title: 'Java', checked: false, tag: TAGS.URGENT },
        {
            title: 'AWS',
            checked: false,
            tag: TAGS.NEW
        },
        { title: 'React Js', checked: true, tag: TAGS.DEFAULT }
    ]);
    ...
    function getNextTag(current = 'Completed') {
